  ...
  dialogues: [
    {
      ...
      text: '¡¡Apareció un chico de la nada!! ¡¿Quién eres?! ¡Si la Capitana Alvida te ve en su barco, nos romperá los huesos con su maza de hierro!',
    },
    {
      id: 'd2',
      speaker: 'Luffy',
      avatar: ' Luffy Strawhat',
      text: '¡Soy Monkey D. Luffy y seré el REY DE LOS PIRATAS! ¡Shishishi! Oye... ¿tienes algo de comer?',
    },
    {
      id: 'd3',
      speaker: 'Koby',
      avatar: ' Koby llorando',
      text: '📍 MISIÓN 1: Hay guardias piratas patrullando la bodega. ¡Golpéalos usando la tecla ESPACIO o tocando el botón 👊 PISTOLA!',
    },
    {
      id: 'd4',
      speaker: 'Koby',
      avatar: ' Koby señalando',
      text: '📍 MISIÓN 2: El portón de rejas está cerrado. ¡Encuentra la LLAVE 🔑 en el COFRE 🟡 de la esquina en (13, 8)!',
    },
    {
      id: 'd5',
      speaker: 'Luffy',
      avatar: ' Luffy feliz',
      text: '➡️ RESUMEN DE MISIÓN: 1) Coge la Llave del cofre en (13,8). 2) Abre el portón de madera. 3) Sube por las ESCALERAS 🪜 en (13,2) a la CUBIERTA del barco.',
    },
  ],
};
  ...
  dialogues: [
    {
      ...
      speaker: 'Koby',
      avatar: ' Koby',
      text: '¡Luffy-san! ¡Encontraste la bodega donde Alvida me obliga a cocinar! Llevo años cautivo en su barco pirata...',
    },
    {
      id: 'zm2',
      speaker: 'Luffy',
      avatar: ' Luffy alegre',
      text: '¡Tranquilo Koby! ¡Vamos a escapar juntos de este barco! ¡Te ayudaré!',
    },
    {
      id: 'zm3',
      speaker: 'Koby',
      avatar: ' Koby esperanzado',
      text: '📍 PISTA CLAVE: Ve por la LLAVE 🔑 en el cofre (13,8), abre el portón y sube por las ESCALERAS 🪜 en (13,2) a la Cubierta.',
    },
    {
      id: 'zm4',
      speaker: 'Luffy',
      avatar: ' Luffy puño',
      text: '💡 CONTROLES: Mueve con W-A-S-D o las Flechas ⬆️⬇️⬅️➡️. Ataca con ESPACIO 👊. Come carne 🍖 con Q si te hieren. ¡A la carga!',
    },
  ],
};

// Dialogue triggered when arriving on Level 2 (Pueblo Shells Town)
  ...
  dialogues: [
    {
      ...
      text: '¡Llegamos a Shells Town! El temible cazador de piratas Roronoa Zoro está amarrado a un poste en el patio de la Marina.',
    },
    {
      id: 'dt2',
      speaker: 'Luffy',
      avatar: ' Luffy sonriendo',
      text: '¡Genial! ¡Si es tan fuerte, le pediré que sea el primer integrante de mi tripulación! ¡Shishishi!',
    },
    {
      id: 'dt3',
      speaker: 'Koby',
      avatar: ' Koby tenso',
      text: '📍 PISTA NIVEL 2: 1) Helmeppo le quitó sus 3 Katanas a Zoro y las encerró en la oficina militar (13,1). 2) Encuentra las Katanas. 3) Desata a Zoro en (8,4). 4) Vence al Capitán Morgan!',
    },
  ],
};
  ...
  dialogues: [
    {
      ...
      text: '¡¿QUIÉN ES ESTE ENANO CON SOMBRERO DE PAJA EN MI CUBIERTA?! ¡Koby! ¡Contesta rápido! ¡¿Quién es la mujer más hermosa de los mares?!',
    },
    {
      id: 'bm2',
      speaker: 'Koby',
      avatar: ' Koby temblando',
      text: 'La mujer más hermosa de los mares es... es... ¡¡ES UNA VIEJA FEA CON PECAS!! ¡¡ME UNIRÉ A LA MARINA Y LUFFY TE DERROTARÁ!!',
    },
    {
      id: 'bm3',
      speaker: 'Alvida',
      avatar: ' Alvida demente',
      text: '¡¡MALDITO ENANO INSOLENTE!! ¡¡TE REVENTARÉ CON MI MAZA DE HIERRO!! ¡¡MUEREEEEE!!',
    },
    {
      id: 'bm4',
      speaker: 'Luffy',
      avatar: ' Luffy puño',
      text: '⚔️ BATALLA DE JEFE: ¡Derrota a la Capitana Alvida con tu Gum-Gum Pistola 👊! ¡Luego coge el Mapa 🗺️ del cofre en (13,8) y escapa en el Bote ⛵ en (2,10)!',
    },
  ],
};
...
export const VICTORY_DIALOGUES: DialogueSequence = {
  ...
  dialogues: [
    ...
    },
    {
      ...
      text: '¡¿C-Cómo es posible este poder...? NOOOO! *Sale disparada por las nubes* AAAAAHH!',
    },
    {
      id: 'vd3',
      speaker: 'Koby',
      avatar: ' Koby asombrado',
      text: '¡Increíble! ¡La mandó a volar por los aires de un solo golpe! ¡Koby es libre!',
    },
    {
      id: 'vd4',
      speaker: 'Luffy',
      avatar: ' Luffy feliz',
      text: '⛵ ZARPAR: ¡Tenemos el Bote Salvavidas y el Mapa del Grand Line! ¡Zarpamos hacia Shells Town a buscar al espadachín Zoro! ¡Shishishi!',
    },
  ],
};
